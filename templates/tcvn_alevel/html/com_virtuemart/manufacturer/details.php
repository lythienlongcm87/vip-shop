...
<div class="manufacturer-details-view">
	...
	<div class="spacer">
        <div class="row-fluid">
            <div class="width55" style="float: left">
                ...
                if(!empty($this->manufacturer->virtuemart_manufacturer_id)) { ?>
                    <div class="manufacturer-product-link">
                        <a style="display:inline-block"  target="_top" href="<?php echo $manufacturerProductsURL; ?>"><?php echo JText::sprintf('COM_VIRTUEMART_PRODUCT_FROM_MF',$this->manufacturer->mf_name); ?></a>
                    </div>
                <?php } ?>

                <div class="clear"></div>
            </div>
            <div class="width45" style="float: right">
