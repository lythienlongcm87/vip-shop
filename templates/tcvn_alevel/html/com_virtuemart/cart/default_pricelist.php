...
<div class="cart">
   ...
   <tbody>
    ...
    foreach ($this->cart->products as $pkey => $prow) {
        ?>
    <tr valign="top" class="cart-products-sectiontab sectiontableentry<?php echo $i ?>">
        <td align="left">
        ...
        <td align="right" style="position: relative"><?php
    ...
    <tr class="sectiontableentry1 product-prices-result">
