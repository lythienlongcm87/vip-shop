...
//]]>
    ...
    <h1><?php echo JText::_('COM_VIRTUEMART_ORDER_ANONYMOUS') ?></h1>
        ...
        <form class="row-fluid" action="<?php echo JRoute::_( 'index.php', 1, $this->useSSL); ?>" method="post" name="com-login" >

            <div class="span4 floatleft" id="com-form-order-number">
            ...
            <div class="span4 floatleft" id="com-form-order-pass">
    ...
    <form id="com-form-login" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
        <fieldset class="userdata">
            ...
            <div class="row-fluid">
                ...
                <p class="span4 floatleft" id="com-form-login-password">
                ...
                <p class="span4 floatleft" id="com-form-login-remember">
                    <input type="submit" name="Submit" class="default btn btn-primary " value="<?php echo JText::_('COM_VIRTUEMART_LOGIN') ?>" />
